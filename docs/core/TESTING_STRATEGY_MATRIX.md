...
| REQ-FIT-AUTH-002 | `spec/models/user_spec.rb`, `spec/requests/user_registrations_spec.rb`, `spec/requests/user_passwords_spec.rb`, `spec/requests/omniauth_auth_spec.rb`, `test/spec/auth_billing_spec_doc_test.rb` |
