...
- **v1 engine:** Per-piece placement uses Shapely (`nest_placement.py`); single-bin batch path uses libnest2d (`nest_libnest2d.nest_sheet`). Full-sheet libnest2d with kerf/obstacles is future work (ADR-0001).
