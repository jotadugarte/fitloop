...
Rails.application.configure do
  ...
  config.action_controller.raise_on_missing_callback_actions = true
    ...
    # ngrok / ONVO webhook local testing
    config.hosts << "barbecue-filing-getting.ngrok-free.dev"
    config.hosts << /.*\.ngrok-free\.dev\z/   # si ngrok te cambia el subdominio al reiniciar
end
