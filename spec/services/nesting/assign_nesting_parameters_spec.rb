...
RSpec.describe Nesting::AssignNestingParameters, "[REQ-FIT-DOM-001]" do
  describe ".call" do
    it "returns kerf and margin value objects for valid params [REQ-FIT-DOM-001]" do
    ...
    it "rejects negative kerf [REQ-FIT-DOM-001]" do
    ...
    it "rejects negative margin [REQ-FIT-DOM-001]" do
    ...
    it "rejects nil kerf or margin [REQ-FIT-DOM-001]" do
    ...
    it "rejects non-numeric kerf [REQ-FIT-DOM-001]" do
