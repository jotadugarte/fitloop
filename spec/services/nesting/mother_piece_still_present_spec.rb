...
RSpec.describe Nesting::MotherPieceStillPresent, "[REQ-FIT-SPLIT-001]" do
  it "returns false when the project has no DXF attachments [REQ-FIT-SPLIT-001]" do
  ...
  it "yields no DXF paths when the project has no attachments [REQ-FIT-SPLIT-001]" do
